//Código desarollado por Semi, https://wa.me/56955274723)
let handler = async(m, {conn, text, participants}) => {
  ...
  conn.sendMessage(m.chat, {text: text ? text : "@kathy_dg8", mentions: participants.map(u => conn.decodeJid(u.id))}, {quoted: m})
  }} else if (m.quoted) {
